...
{
	while(I2C_GetFlagStatus(I2C1, I2C_FLAG_BUSY));  // I2C meşgul olduğu süre boyunca bekle

	I2C_GenerateSTART(I2C1, ENABLE);	// I2C haberleşmesi başlatılıyor
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  lcd_send_string("A");
	  delay(21000000);
	  lcd_send_cmd(0xC0); // LCD'nin 2. satır 1. sütununa git (adres 0x40)
	  lcd_send_string("M");
	  delay(21000000);
	  lcd_send_cmd(0xC1);
	  lcd_send_string("E");
